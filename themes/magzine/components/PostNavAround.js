    ...
    <div id='article-end'>
      ...
      <section className='lg:hidden pt-8 text-gray-800 items-center text-xs md:text-sm flex flex-col m-1 '>
        <SmartLink
          href={`/${prev.slug}`}
          passHref
          className='cursor-pointer justify-between space-y-1 px-5 py-6 dark:bg-surface-3 border border-black/[0.08] dark:border-white/[0.06] border-b-0 items-center dark:text-white flex flex-col w-full h-18 duration-200'>
        ...
        <SmartLink
          href={`/${next.slug}`}
          passHref
          className='cursor-pointer justify-between space-y-1 px-5 py-6 dark:bg-surface-3 border border-black/[0.08] dark:border-white/[0.06] items-center dark:text-white flex flex-col w-full h-18 duration-200'>
      ...
      <div
        ...
        <SmartLink
          href={`/${next.slug}`}
          className='text-sm block p-4 w-72 h-28 cursor-pointer shadow-notion-md duration transition-all dark:bg-surface-3 border border-black/[0.08] dark:border-white/[0.06] bg-white dark:text-gray-300 hover:text-accent dark:hover:text-accent rounded-card'>
